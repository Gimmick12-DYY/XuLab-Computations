...
# accessible bins). After imputation many (region, cell) entries carry a
# positive value, so we count entries above a series of thresholds.
# Reads the imputed_Prc_hdf5_all.h5 schema produced by 05_impute.py for any
# of the three pipelines (cisTopic, FITS, scOpen).
